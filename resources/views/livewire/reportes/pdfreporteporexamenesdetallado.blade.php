                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="invoice-title invoice">
                        <h5 class="text-center mb-1 text-info"><strong>Ingresos por exámenes solicitados</strong></h5>
                    </div>
                  </div>
                    <div class="col-xs-12">
                        ...
                        <p class="mb-0"><strong>Total Ingresos: </strong>{{ number_format($total,2) }} Bs.</p>
                    </div>
                      ...
                      <table class="table table-condensed" style="margin-top:80px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{number_format($r->cantidad*$r->price,2)}}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
