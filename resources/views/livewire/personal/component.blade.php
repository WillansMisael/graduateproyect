    ...
    <div class="div col-sm-12 col-md-12 col-lg-12 layout-spacing">
        @if ($action == 1)
            <div class="widget-content-area br-4">
                ...
                @include('common.search',['crear' => 'personal_crear']) <!-- búsqueda y botón para nuevos registros -->
                <!-- tabla -->
                            ...
                            @foreach ($info as $r)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @include('common.actions',['editar' => 'personal_editar','eliminar' => 'personal_eliminar']) <!-- botons editar y eliminar -->
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        @elseif($action == 2)
        @include('livewire.personal.form')
        @endif
    </div>
</div>
<script>
    function Confirm(id) {
        let me = this
            ...
            function() {
                ...
                toastr.success('info', 'Personal eliminado con éxito') //mostramos mensaje de confirmación 
