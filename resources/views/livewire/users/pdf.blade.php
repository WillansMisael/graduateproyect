                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="invoice-title invoice">
                        <h5 class="text-center mb-1 text-info"><strong>Lista de Credenciales de acceso</strong></h5>
                    </div>
                  </div>
                    <div class="col-xs-12">
                        <p class="mb-0"><strong>Fecha de Consulta: </strong>{{\Carbon\Carbon::now()->format('d-m-Y')}}</p>
                        <p class="mb-0"><strong>Número de instituciones: </strong>{{ $info->count() }}</p>
                    </div>
                    <div class="table-responsive ">
                      <table class="table table-condensed" style="margin-top:70px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="">{{$r->id}}</td>
                                    <td class="">{{$r->name}} {{$r->last_name}}</td>                                                    
                                    <td class="">{{$r->email}}</td>
                                </tr>
                            @endforeach
                            </tbody>
