                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="invoice-title invoice">
                        <h5 class="text-center mb-1 text-info"><strong>Lista de Médicos</strong></h5>
                    </div>
                  </div>
                    <div class="col-xs-12">
                        <p class="mb-0"><strong>Fecha de Consulta: </strong>{{\Carbon\Carbon::now()->format('d-m-Y')}}</p>
                        <p class="mb-0"><strong>Número de médicos: </strong>{{ $info->count() }}</p>
                    </div>
