                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="invoice-title invoice">
                        <h5 class="text-center mb-1 text-info"><strong>Lista de Pacientes</strong></h5>
                    </div>
                  </div>
                    <div class="col-xs-12">
                        <p class="mb-0"><strong>Fecha de Consulta: </strong>{{\Carbon\Carbon::now()->format('d-m-Y')}}</p>
                        <p class="mb-0"><strong>Número de pacientes: </strong>{{ $info->count() }}</p>
                    </div>
                      ...
                      <table class="table table-condensed" style="margin-top:70px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class=""colspan="2">{{$r->date_nac}}</td>
                                    <td class="">{{$r->direction}}</td>
                                    <td class="">{{$r->telephone}}</td>
                                    <td class="">{{$r->cel}}</td>                                                    
                                    <td class="">{{$r->cod_inst}}</td>                                                    
                                    <td class="">{{$r->state}}</td>                                                    
                                </tr>
                            @endforeach
                            </tbody>
